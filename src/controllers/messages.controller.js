const { sendInteractiveButtons2, sendInteractiveButtons } = require("../services/whatsapp.service");
...
module.exports = { sendMessageEndpoint2Controller, sendMessageEndpointInteractiveController };
